...
| `eck-monitoring` | `0.3.1` | Consumer, Provider, GA | https://code.europa.eu/simpl/simpl-open/development/monitoring/eck-monitoring.git |
...
| `identity-provider` | `2.11.3` | GA | https://code.europa.eu/simpl/simpl-open/development/iaa/identity-provider.git |
...
| `onboarding` | `2.12.7` | GA | https://code.europa.eu/simpl/simpl-open/development/iaa/onboarding.git |
...
| `security-attributes-provider` | `2.12.3` | GA | https://code.europa.eu/simpl/simpl-open/development/iaa/security-attributes-provider.git |
...
| `tier2-proxy` | `1.5.4` | Consumer, Provider, GA | https://code.europa.eu/simpl/simpl-open/development/iaa/tier2-proxy.git |
| `users-roles` | `2.12.6` | Consumer, Provider, GA | https://code.europa.eu/simpl/simpl-open/development/iaa/users-roles.git |
